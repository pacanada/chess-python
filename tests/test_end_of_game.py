...
def test_draw_by_repetition():
    ...
    game.move("f8e7")
    game.update_outcome()
    assert game.is_threefold_repetition==False, "This combination of moves should not be draw by repetition"
...
def test_draw_by_insufficient_material():
    ...
    game.update_outcome()
    assert game.is_draw_by_insufficient_material, "This combination of moves should be draw by insufficient material"
    ...
    game.update_outcome()
    assert game.is_draw_by_insufficient_material==False, "This combination of moves should not be draw by insufficient material"
